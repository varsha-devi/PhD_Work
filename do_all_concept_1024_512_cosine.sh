...
exp_name=concept_512
postfix=runs_concept_$concept_space_size
...
--exp_name $exp_name --postfix $postfix --num_epochs $num_epochs \
--measure_2 cosine >& $TMP_ROOT/trc/$postfix
