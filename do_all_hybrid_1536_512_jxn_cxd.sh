...
exp_name=hybrid_1536_512_jxn_cxd
postfix=runs_$1
...
--exp_name $exp_name --postfix $postfix --measure jaccard --latent_no_dp \
--measure_2 cosine --concept_xi --concept_dp >& $TMP_ROOT/trc/${exp_name}_$postfix
