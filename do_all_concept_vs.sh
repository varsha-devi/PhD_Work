...
CODE_ROOT=$IRIM/pytorch/PhD_Varsha_MRIM/hybrid_space_v3
...
exp_name=concept_dims_$pos_tag_vocab
...
--exp_name $exp_name --postfix $postfix --use_postag_vocab $pos_tag_vocab >& $TMP_ROOT/trc/$postfix
