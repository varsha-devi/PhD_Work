...
exp_name=latent_512
postfix=runs_latent_$latent_space_size
...
--visual_mapping_layers 0-$latent_space_size \
--collection $collection --visual_feature $visual_feature --space $space \
--exp_name $exp_name --postfix $postfix --num_epochs $num_epochs >& $TMP_ROOT/trc/$postfix
