...
TMP_ROOT=/tmp/dual_encoding_experiments/VisualSearch
...
--visual_mapping_layers 0-$latent_space_size --collection $collection --visual_feature $visual_feature --space $space \
--exp_name $exp_name --postfix $postfix >& $TMP_ROOT/trc/$postfix
