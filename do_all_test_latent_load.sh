...
time python tester.py --collectionStrt $collectionStrt --testCollection $testCollection --rootpath $rootpath --overwrite $overwrite --logger_name $logger_name --load_embs embs_pca.pth --log_file logging_$pca --truncate_latent $pca
